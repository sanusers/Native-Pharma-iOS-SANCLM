...
class TagVC : UIViewController {
    ...
    func tagging() {
        ...
        let urlStr = AppDefaults.shared.webUrl + AppDefaults.shared.iosUrl + "geodetails"
 ...
 //   http://crm.saneforce.in/iOSServer/db_module.php?axn=get/geodetails
    ...
    func updateTagList()  {
        ...
        let url = AppDefaults.shared.webUrl + AppDefaults.shared.iosUrl + "table/dcrmasterdata"
