...
//        self.btnProfile.isSelected = true
    ...
    @IBAction func todayCallSyncAction(_ sender: UIButton) {
        ...
        let url =  AppDefaults.shared.webUrl + AppDefaults.shared.iosUrl + "table/additionaldcrmasterdata"
    ...
    private func fetchHome () {
        ...
        let url = AppDefaults.shared.webUrl + AppDefaults.shared.iosUrl + "home"
    ...
    private func fetch() {
        ...
        let url = AppDefaults.shared.webUrl + AppDefaults.shared.iosUrl + "homedashboard"
